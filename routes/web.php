        ...
        if ($json["_id"] === 0) {
            $filter = Filter::create(
                [
                    ...
                    'brand' => $json['brand'],
                    'model' => $json['model'],
                    'priceStart' => intval($json['priceStart']),
                    'priceEnd' => intval($json['priceEnd']) > 0 ? intval($json['priceEnd']) : 999999999,
                    'region' => $json['region'],
                    'city' => $json['city'],
                    'city_name' => $json['city_name'],
                    'yearStart' => intval($json['yearStart']),
                    'yearEnd' => intval($json['yearEnd']),
